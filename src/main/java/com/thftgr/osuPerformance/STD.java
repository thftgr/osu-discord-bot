...
public class STD {
    ...
    public double Calculate(JsonObject map) {
        ...
        aimStars = map.get("diff_aim").getAsDouble(); //diff_aim
        speedStars = map.get("diff_speed").getAsDouble(); //diff_speed
        beatmapMaxCombo = map.get("max_combo").getAsInt(); // max_combo
        scoreMaxCombo = map.get("max_combo").getAsInt();
        ar = map.get("diff_approach").getAsDouble(); // diff_approach
        od = map.get("diff_overall").getAsDouble(); // diff_overall
        n300 = map.get("count_normal").getAsInt() + map.get("count_slider").getAsInt() + map.get("count_spinner").getAsInt();
        countHitCircles = map.get("count_normal").getAsInt(); //count_normal
        totalHits = totalHits();
